...
- (void)trackLocation:(NSArray *)params
{
  ...
  CLLocation *location = [[CLLocation alloc] initWithLatitude:[[params objectAtIndex:0] doubleValue] longitude:[[params objectAtIndex:1] doubleValue]];
...
- (TiOmnitureMediaSettings *)createMediaSettings:(id)params
{
  ...
  if (mediaSettings) {
    TiOmnitureMediaSettings *proxy = [[TiOmnitureMediaSettings alloc] initWithMediaSettings:mediaSettings];
...
- (TiOmnitureMediaSettings *)createAdMediaSettings:(id)params
{
  ...
  ADBMediaSettings *mediaSettings = [ADBMobile mediaAdCreateSettingsWithName:name
                                                           ...
                                                           parentPodPosition:[parentPodPosition doubleValue]
                                                                         CPM:cpm];
  if (mediaSettings) {
    return [[TiOmnitureMediaSettings alloc] initWithMediaSettings:mediaSettings];
  }
  return nil;
}
...
- (void)mediaOpen:(NSArray *)params
{
  ...
  [ADBMobile mediaOpenWithSettings:mediaSettingsProxy.adbMediaSettings
                          callback:^(ADBMediaState *mediaState) {
                            if (callback) {
                              TiOmnitureMediaState *mediaStateProxy = [[TiOmnitureMediaState alloc] initWithMediaState:mediaState];
...
- (TiOmnitureTargetLocationRequest *)createTargetLocationRequest:(id)params
{
  ...
  return [[TiOmnitureTargetLocationRequest alloc] initWithTargetLocationRequest:[ADBMobile targetCreateRequestWithName:name
...
- (TiOmnitureTargetLocationRequest *)createTargetOrderConfirmRequest:(id)params
{
  ...
  return [[TiOmnitureTargetLocationRequest alloc] initWithTargetLocationRequest:[ADBMobile targetCreateOrderConfirmRequestWithName:name
                                                                                                                           orderId:orderId
...
- (void)audienceSignalWithData:(NSArray *)params
{
  ...
  [ADBMobile audienceSignalWithData:data
