...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','ti.omniture.js')
	if not os.path.exists(js_file):
		js_file = os.path.join(cwd,'..','assets','com.logicallabs.example.js')
...
""" % module_assets
	...
	assets_router = os.path.join(cwd,'Classes','TiOmnitureModuleAssets.m')
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','ti.omniture.js']
